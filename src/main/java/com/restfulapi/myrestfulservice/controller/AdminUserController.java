...
import com.restfulapi.myrestfulservice.bean.AdminUser;
import com.restfulapi.myrestfulservice.bean.AdminUserV2;
...
//    @GetMapping(value = "/users/{id}", params = "ver=1")
...
//    @GetMapping(value = "/users/{id}", params = "ver=2")
